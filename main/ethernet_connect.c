...
void start_connect_ethernet(void)
{
    ...
    phy_config.reset_gpio_num = 5; // GPIO RST
    ...
    spi_bus_config_t buscfg = {
        .miso_io_num = 19, // GPIO MISO
        .mosi_io_num = 23, //  GPIO MOSI
        .sclk_io_num = 18, // GPIO SCLK
        .quadwp_io_num = -1,
        .quadhd_io_num = -1,
    };
    ...
    ESP_ERROR_CHECK(esp_eth_ioctl(eth_handle, ETH_CMD_S_MAC_ADDR, (uint8_t[]){0x02, 0x00, 0x00, 0x12, 0x44, 0x56}));
